# Generated by Powerlevel10k configuration wizard on 2025-07-24 at 12:38 EDT.
...
# flat heads, flat tails, 2 lines, solid, left frame, compact, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=234 #238 # NOTE: the dir background color
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=051 #31 NOTE: colors the / separator
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=051 #103 # NOTE: colors the dir text
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=051 #39
